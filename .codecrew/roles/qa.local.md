<!--
.codecrew/roles/qa.local.md — this project's extension to the qa contract.
Loaded after .codecrew/roles/qa.md, append-only, never a replacement: an extension
that contradicts its contract is a review finding. gh codecrew roles show qa
