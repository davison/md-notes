<!--
.codecrew/roles/coordinator.local.md — this project's extension to the coordinator contract.
Loaded after .codecrew/roles/coordinator.md, append-only, never a replacement: an extension
that contradicts its contract is a review finding. gh codecrew roles show coordinator
