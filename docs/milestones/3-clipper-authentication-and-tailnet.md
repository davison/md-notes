...
| An extension pointed at a tailnet daemon URL can read and open notes but cannot clip or register a folder: both are loopback-only | [the introduction](../introduction.md#what-is-reachable-under-that-name-and-what-is-not) |
